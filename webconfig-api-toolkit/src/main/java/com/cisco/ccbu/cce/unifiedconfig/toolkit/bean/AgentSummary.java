...
@Path("agent")
@XmlRootElement(name="agentSummary")
public class AgentSummary extends BaseApiBean {
  ...
  public static class AgentSummaryList extends BaseApiListBean<AgentSummary> {
    @XmlElementWrapper(name = "agentSummarys")
    @XmlElement(name = "agentSummary")
    public List<AgentSummary> getItems() {
      return items;
    }

    public void setItems(List<AgentSummary> items) {
      this.items = items;
    }
  }
}
